        ...
        >
          {({
            ...
            <form
              ...
              className="px-2 w-full max-w-md h-full"
            >
              <img
                src={logo}
                alt="login"
                className="w-full h-56 object-cover rounded mt-5 "
              />
              <h1 className="text-3xl font-serif text-center mb-1">
                Welcome Back!
              </h1>
              <p className="text-center font-serif text-sm mb-6 opacity-40">
              ...
              <p className="text-center font-serif text-sm mb-6 opacity-85">
              ...
              {authError && (
                <p className="text-red-600 mt-2 text-center">{authError}</p>
              )}
            </form>
          )}
        </Formik>
